...
.data
	...
	back Byte 08h
	str1 byte "asdasfsdkjfasdf asdfsadfkjwer wqsdfaksdjfasdlkfjasdfdsf sd wrwekjfklasjflksadjfasd wiwriownlkxmcnvasdifjfg akdxfjasklvnzx,mc",0
	line1 byte "-----------------------------------------------------------------------------------------------------------------------",0
	char Byte ?
	...
	str_index dword 0
	is_win byte 0
	win_message byte "YOU WON!!!",0
	lose_message byte "YOU LOSE!!",0
.code
